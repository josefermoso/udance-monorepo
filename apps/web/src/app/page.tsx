          ...
          {user && (
            <div className="mt-12 border-t pt-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <a
                  href="/admin"
                  className="bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 text-white p-6 rounded-xl transition-all transform hover:scale-105 shadow-lg hover:shadow-xl"
                >
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-white/80 text-sm">Manage venues, events, and users</p>
                    </div>
                  </div>
                </a>
                ...
                <a
                  href="/app"
                  className="bg-gradient-to-r from-pink-500 to-rose-600 hover:from-pink-600 hover:to-rose-700 text-white p-6 rounded-xl transition-all transform hover:scale-105 shadow-lg hover:shadow-xl"
                >
                  <div className="flex items-center space-x-4">
                    <div className="bg-white/20 rounded-lg p-3">
                      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div>
                      <h4 className="text-xl font-semibold">Mobile App</h4>
                      <p className="text-white/80 text-sm">PWA optimized for mobile devices</p>
                    </div>
                  </div>
                </a>
              </div>
              ...
              <div className="mt-4 text-center">
                <p className="text-gray-500 text-sm">
                  💡 <strong>Tip:</strong> Add the mobile app to your home screen for the best experience!
                </p>
              </div>
            </div>
          )}
