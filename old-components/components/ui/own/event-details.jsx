  ...
  return (
    <div className="container mx-auto p-6">
      ...
      <div className="mb-6 rounded-lg bg-primary-gradient p-6 shadow-lg">
        {/* Title and date */}
        <div>
          <Heading variant="h1" className="font-semibold text-white">
            {event.title}
          </Heading>
      ...
      <div className="bg-warm-gradient/5 mb-6 rounded-lg p-6">
        <Heading
          variant="h2"
          className="bg-primary-gradient bg-clip-text font-semibold text-transparent"
        >
          Descripción
        </Heading>
      ...
      <div className="bg-accent-gradient/5 mb-6 rounded-lg p-6">
        <Heading
          variant="h2"
          className="bg-cool-gradient bg-clip-text font-semibold text-transparent"
        >
          Ubicación
        </Heading>
        <Text className="mb-4 text-gray-500">{event.address}</Text>
        {/* Mapa estilizado */}
