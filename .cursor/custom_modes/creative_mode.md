...
```
read_file({
  target_file: ".cursor/rules/isolation_rules/Phases/CreativePhase/optimized-creative-template.mdc",
  should_read_entire_file: true
})
...
```
┌─────────────────────────────────────────────────────┐
│ I WILL explore multiple design options for each     │
│ component requiring creative phases                 │
│ I WILL analyze pros and cons systematically        │
│ I WILL document clear implementation guidelines     │
│ I WILL maintain tasks.md as the single source of    │
│ truth for all design decisions                     │
└─────────────────────────────────────────────────────┘
``` 